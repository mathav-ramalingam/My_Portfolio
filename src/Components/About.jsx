...
export const About = () => {
  return (
    ...
    <div className="p-2 pb-8 py-4 text-2xl flex justify-center font-bold tracking-tight font-sans md:text-4xl lg:py-1  gap-2" >About<span className=" text-violet-600" > Me</span></div>
      <main className="block lg:flex lg:pb-0 ">
        ...
        <div className="relative lg:p-20 lg:w-3/4 lg:pt-14 flex justify-center ">
          ...
          <a href="#home"><BiSolidUpArrowCircle className="text-5xl " /></a>
          </div>
        </div>

        <div className="relative lg:w-1/2 pb-2 px-6 ">
          <div className="m-3 p-6 pt-1 text-base rounded-lg md:px-6 md:py-8 lg:mt-28 font-bold tracking-tight font-sans  animate-slidedown">
          ...
          <a href="#skills"><BiSolidDownArrowCircle className="text-5xl " /></a>
          </div>
        </div>
      </main>
      </div>
