...
export const Home = () => {
  return (
   ...
   <main className='block lg:flex  '>
    <div className='p-5 pt-20 pl-14 bg-red-600  lg:w-1/2 md:p-32 md:pt-48' >
    <h1 className="text-xl md:text-4xl  flex font-bold tracking-tight text-white font-sans ">
            Hi, I'm Mathav Ramalingam
            <svg
              width="36"
              height="36"
              viewBox="0 0 48 48"
              ...
              className="ml-2 w-6 h-7 md:w-9 md:h-9 hover:animate-handshake "
            >
                    <path
                ...
                <h1 className='mt-2 text-2xl md:mt-4 md:text-5xl font-bold tracking-tight font-sans'>Stack</h1>
    </div>

    <div className='bg-green-600 p-14 lg:w-1/2 md:p-28 md:pl-44'>
    <img src={profile} className='w-72 md:w-96 rounded-full grayscale hover:grayscale-0 '></img>
