...
export const Skills = () => {
  return (
    <>
      <div id="skills" className="pt-4 md:pt-16 bg-white dark:bg-[#1a1a1a] text-black dark:text-white  ">
        ...
        <div className="md:grid grid-cols-2 gap-10 px-4 md:px-16  ">
          <div className="mb-10  md:mb-0  ">
            <div className=" rounded-3xl md:py-1 md:mt-8 border-cyan-300 border-2 shadow-custom animate-slideIn">
          ...
          <div className="mb-10 md:mb-0">
            <div className=" rounded-3xl md:py-1 md:mt-8 border-cyan-300 border-2 shadow-custom animate-slideout">
              <div className="text-2xl flex justify-center font-bold tracking-tight font-sans md:text-3xl md:pt-2 pt-2 ">
                Backend
              </div>
              <div className="p-4 grid grid-cols-2 md:grid md:grid-cols-3 gap-2 content-center md:p-6">
                ...
                <div className="text-sm py-2 flex items-center justify-center bg-transparent  font-medium md:px-4 md:py-3 rounded-2xl md:w-auto md:text-lg   ">
                  <img
                    src={e}
                    className="text-base mr-2 md:text-lg size-7 "
                  />
                  Express JS
                </div>
              </div>
          ...
          <div className="relative mb-10 md:mb-0">
            <div className="mx-8 my-6  md:py-1 md:mt-8 border-cyan-200 border-2 shadow-custom rounded-3xl  animate-slideup">
              <div className="text-2xl flex justify-center font-bold tracking-tight font-sans md:text-3xl md:pt-2 pt-2 ">
                Others
              </div>
              <div className="p-4 grid grid-cols-2 md:grid md:grid-cols-2 gap-2 content-center md:p-6">
                ...
                <div className="text-sm py-2 flex items-center justify-center bg-transparent  font-medium md:px-4 md:py-3 rounded-2xl md:w-auto md:text-lg ">
                  <img src={c} className="text-base mr-2 md:text-lg size-5 " />C
                </div>
                <div className="text-sm py-2 flex items-center justify-center bg-transparent  font-medium md:px-4 md:py-3 rounded-2xl md:w-auto md:text-lg ">
                  <img
                    src={gitl}
